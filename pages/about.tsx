...
export default function About() {
  return (
    <Container title="About – Alibek Kaliyev">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16 w-full">
        ...
        <div className="mb-8 prose dark:prose-dark leading-6">
          ...
          <ul>
            <li>
              Twitter: <a href="https://twitter.com/alibek_kaliyev">@alibek_kaliyev</a>
            </li>
            <li>
              GitHub: <a href="https://github.com/abekek">@abekek</a>
            </li>
            <li>
              Website: <Link href="https://abekek.github.io">https://abekek.github.io</Link>
            </li>
            <li>
              LinkedIn:{' '}
              <a href="https://www.linkedin.com/in/abekek/">
                https://www.linkedin.com/in/abekek
              </a>
            </li>
          </ul>
          <h2>Bio</h2>
          <h3>Job Title</h3>
          <p>Alibek Kaliyev, VP of Developer Experience at Vercel</p>
          <h3>Long, 3rd Person</h3>
          <p>
            Alibek Kaliyev is the VP of Developer Experience at{' '}
          ...
          <h3>Education</h3>
          <p>
            Alibek Kaliyev graduated from Iowa State University with a B.S. in
